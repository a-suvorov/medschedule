...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <div class="rules reveal-modal medium" id="rules" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
        ...
        <ul class="rules-list">
          <li class="rules-list__item">Используя систему, Вы подтверждаете согласие на обработку персональных данных согласно ФЗ-152</li>
          ...
          <li class="rules-list__item">Если по каким либо причинам вы не можете войти в систему - еще раз проверьте правильность введенных данных, если данные верны, то в этом случае необходимо обратиться в регистратуру поликлиники</li>
